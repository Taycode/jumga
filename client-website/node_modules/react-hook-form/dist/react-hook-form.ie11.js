  ...
  var setInternalValue = useCallback(function (name, value) {
    ...
    if (field) {
      ...
      for (var key in value) {
        var fieldName = "" + name + (isValueArray ? "[" + key + "]" : "." + key);
        var field_1 = fieldsRef.current[fieldName];

        if (field_1) {
          setFieldValue(field_1, get$1(value, key));
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            return [4
            /*yield*/
            , validateWithSchema(validationSchema, validateAllFieldCriteria, getFieldValueByName(fieldsRef.current), validationResolver, validationContext)];
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          case 0:
            ...
            return [4
            /*yield*/
            , validateWithSchema(validationSchema, validateAllFieldCriteria, getFieldValueByName(fields), validationResolver, validationContext)];
  ...
  function watch(fieldNames, defaultValue) {
    ...
    if (isArray$4(fieldNames)) {
      return reduce$2(fieldNames).call(fieldNames, function (previous, name) {
        ...
        if (isEmptyObject(fieldsRef.current) && isObject$1(combinedDefaultValues)) {
        ...
        return __generator(this, function (_c) {
          ...
          switch (_c.label) {
            ...
            case 1:
              ...
              return [4
              /*yield*/
              , validateWithSchema(validationSchema, validateAllFieldCriteria, transformToNestObject(fieldValues), validationResolver, validationContext)];
                    ...
                    switch (_a.label) {
                      ...
                      case 1:
                        ...
                        if (!fields[name]) {
                          return [2
                          /*return*/
                          , promise$3.resolve(resolvedPrevious)];
                        }
...
function useFormContext() {
  var context = React.useContext(FormGlobalContext);
...
var useFieldArray = function (_a) {
  ...
  var append = function (value) {
    ...
    commonTasks(__spread(fields, isArray$4(value) ? appendValueWithKey(value) : [appendId(value, keyName)]));
  };

  var prepend = function (value) {
    mapCurrentFieldsValueWithState();
    resetFields();
    commonTasks(prependAt(fields, isArray$4(value) ? appendValueWithKey(value) : [appendId(value, keyName)]));
  ...
  var remove = function (index) {
    ...
    if (readFormStateRef.current.isValid && !validateSchemaIsValid) {
      ...
      while (fieldIndex++ < fields.length) {
        ...
        var isCurrentIndex = indexOf$3(_context2 = isArray$4(index) ? index : [index]).call(_context2, fieldIndex) >= 0;
  ...
  var insert = function (index, value) {
    ...
    commonTasks(insertAt(fields, index, isArray$4(value) ? appendValueWithKey(value) : [appendId(value, keyName)]));
...
var getInputValue = (function (event, isCheckboxInput) {
  return isPrimitive(event) || !isObject$1(event.target) || isObject$1(event.target) && !event.target.type ? event : isCheckboxInput || isUndefined(event.target.value) ? event.target.checked : event.target.value;
});
