...
export declare type ValidationResolver<FormValues, ValidationContext> = (values: FormValues, validationContext?: ValidationContext) => {
    values: FormValues | {};
    errors: FieldErrors<FormValues> | {};
};
export declare type UseFormOptions<FormValues extends FieldValues = FieldValues, ValidationContext = any> = Partial<{
    mode: Mode;
    reValidateMode: Mode;
